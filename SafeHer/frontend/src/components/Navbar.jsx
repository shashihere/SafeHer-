                ...
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center shrink-0">
                        <Link to="/" className="flex items-center gap-2.5 group">
                            <div className="p-0.5 bg-black rounded-full overflow-hidden transition-all group-hover:scale-105 border border-gray-200 shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                                <img src="/logo.jpg" alt="SafeHer Logo" className="w-9 h-9 object-cover rounded-full" />
                            </div>
                            <span className="font-cursive font-bold text-2xl tracking-wide text-black transition-colors">
                                SafeHer
                            </span>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-3 md:gap-4 lg:gap-5">
                        {user ? (
                            <>
                                ...
                                <button onClick={handleSOS} className="ml-1 md:ml-2 bg-red-600 hover:bg-red-700 text-black px-3 py-1.5 font-bold tracking-widest text-xs flex items-center gap-1.5 animate-pulse rounded-md shadow-[0_0_10px_rgba(220,38,38,0.4)] whitespace-nowrap">
