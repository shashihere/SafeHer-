    ...
    return (
        <div className="flex-grow flex items-center justify-center p-4 bg-transparent min-h-[calc(100vh-80px)]">
            <div className="w-full max-w-lg bg-white border border-slate-200 hover:border-blue-600 p-10 md:p-14 relative overflow-hidden transition-all duration-700 group hover:shadow-[0_0_40px_rgba(255,255,255,0.1)]">
                ...
                {/* Decorative Elements */}
                <div className="absolute top-0 right-0 w-32 h-32 border-r border-t border-slate-200 group-hover:border-blue-600 transition-all duration-700 opacity-50 -mt-16 -mr-16 rotate-45 transform group-hover:rotate-90"></div>
                
                <div className="relative z-10">
                    <div className="flex justify-center mb-8">
                        <div className="p-4 bg-blue-600 text-white hover:bg-blue-700 inline-block transform group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="mt-10 border-t border-gray-300 pt-8 text-center">
                        <p className="text-slate-800 uppercase tracking-widest text-xs">
                            ...
                            <Link to="/register" className="ml-2 text-slate-800 font-bold border-b border-transparent hover:border-blue-600 pb-1 transition-all">Sign up</Link>
                        </p>
                    </div>
                </div>
            </div>
