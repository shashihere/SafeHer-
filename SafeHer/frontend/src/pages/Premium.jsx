...
const Premium = () => {
    return (
        <div className="min-h-screen bg-transparent text-slate-800 pt-24 pb-20">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-24">
                    <h1 className="text-6xl md:text-8xl font-cursive mb-6">Gain Your Trust</h1>
                    <p className="text-slate-600 max-w-2xl mx-auto text-lg leading-relaxed font-sans uppercase tracking-widest text-sm">
                ...
                <div className="space-y-40">
                    ...
                    <section className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 space-y-8">
                            ...
                            <div className="inline-flex items-center gap-3 border-b-2 border-blue-600 pb-2 font-bold uppercase tracking-widest text-sm">
                        ...
                        <div className="order-1 lg:order-2">
                            <img 
                                ...
                                className="w-full border border-slate-200 hover:border-blue-600 transition-colors"
                            />
                        </div>
                    </section>
