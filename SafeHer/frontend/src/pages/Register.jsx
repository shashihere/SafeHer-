...
const Register = () => {
    ...
    return (
        <div className="flex-grow flex items-center justify-center p-4 min-h-[calc(100vh-80px)] py-12 bg-[#fcfcfc]">
            <div className="w-full max-w-md bg-white rounded-3xl p-8 md:p-10 soft-shadow-lg border border-gray-50">
                ...
                <h2 className="text-3xl font-extrabold text-center mb-2 text-[#1d1d1d]">Create your safe space</h2>
                <p className="text-center text-gray-500 mb-8 font-medium">Join Raksha to protect what matters.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="pt-2">
                        <button disabled={loading} type="submit" className="w-full bg-blue-600 text-white font-bold py-4 px-4 rounded-2xl shadow-md hover:bg-blue-700 hover:-translate-y-0.5 hover:shadow-lg transition-all text-lg flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                            {loading ? <Loader2 className="w-6 h-6 animate-spin text-white" /> : <>Create account <ArrowRight className="w-5 h-5"/></>}
                        </button>
                    </div>
                </form>
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-500 font-medium">
                        ...
                        <Link to="/login" className="ml-2 text-blue-600 hover:text-blue-700 font-bold hover:underline underline-offset-4 transition-all">Log in</Link>
                    </p>
                </div>
            </div>
        </div>
