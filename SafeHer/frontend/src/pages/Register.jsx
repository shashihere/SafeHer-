...
const Register = () => {
    ...
    return (
        <div className="flex-grow flex items-center justify-center p-4 bg-transparent min-h-[calc(100vh-80px)] py-12 relative overflow-hidden">
            {/* Background Glows */}
            ...
            <div className="w-full max-w-lg bg-slate-900/40 backdrop-blur-xl border border-white/10 hover:border-blue-500/30 p-10 md:p-14 rounded-3xl relative z-10 transition-all duration-700 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                ...
                <div className="relative z-10">
                    ...
                    <h2 className="text-4xl font-extrabold font-cursive text-center mb-2 tracking-wide text-white drop-shadow-md">Join Raksha</h2>
                    <p className="text-center text-slate-400 mb-10 font-sans tracking-widest uppercase text-xs font-bold">Your safety matters. Create a secure vault.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="group/input">
                            <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 group-focus-within/input:text-blue-400 transition-colors">Full Name</label>
                            <input 
                                type="text" 
                        ...
                        <div className="pt-4">
                            <button disabled={loading} type="submit" className="w-full bg-blue-600 text-white hover:bg-blue-500 font-bold py-4 px-4 rounded-xl transition-all uppercase tracking-widest text-sm flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(37,99,235,0.4)] hover:shadow-[0_0_25px_rgba(37,99,235,0.6)] disabled:opacity-50 disabled:cursor-not-allowed">
                                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : 'Create Secure Identity'}
                            </button>
                        </div>
                    </form>
                    ...
                    <div className="mt-8 pt-6 text-center">
                        <p className="text-slate-400 uppercase tracking-widest text-xs font-bold">
                            ...
                            <Link to="/login" className="ml-2 text-blue-400 hover:text-blue-300 transition-colors">Log in</Link>
                        </p>
                    </div>
                </div>
            </div>
